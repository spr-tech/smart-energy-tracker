...
const Tips = () => {
  const tipsObj = [
    ...
    {
      icon: <MoonStar size={30} className="text-button  bg-" />,
  ...
  return (
    <div>
      ...
      {/* tip cards */}
      <section className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] md:grid-cols-2 gap-4 w-full h-50 round ">
          ...
          >
            <header className="flex gap-2 items-center">
              ...
              <div className="flex flex-col gap-2 ">
                <h1 className="text-sm font-bold md:text-xl md ">{tip.head}</h1>
