...
const AppLayout = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen ">
      ...
      <aside className="md:flex flex-col bg-[#ffffff] order-2 md:order-1 md:border-r md:border-gray-300/70 md:min-w-70">
        {/* logo */}
        ...
        <nav className="flex-1">
          <div className="flex  justify-around  p-3 border-t border-gray-300/70 md:flex-col md:gap-3 md:m-4  md:border-t-0 md:w-60">
            <SidebarLinks
              to="/"
        ...
        <footer className=" hidden md:flex p-7 flex-col gap-7">
